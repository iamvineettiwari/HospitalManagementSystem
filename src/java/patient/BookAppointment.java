            ...
            if (session.getAttribute("user_type") != null) {
                if (session.getAttribute("user_type").toString().equalsIgnoreCase("patient")) {
                    ...
                    out.println("<div class=\"row\">"
                            ...
                            + "</div>"
                            + "<div class=\"card-body\">"
                            + "<form class=\"user\" action=\"ConfirmAppointment\" method=\"post\">"
                    ...
                    db.pstmt = db.con.prepareStatement("SELECT did,dname FROM doctor_reg");
                    ...
                    out.println("</select>"
                            ...
                            + "</div>"
                            + "<input type=\"submit\" name=\"placeOrder\" value=\"Place Appointment\"  class=\"btn btn-primary btn-user btn-block\">"
                            + "</form>"
                            + "</div>"
                            + "</div>"
                            + "</div>"
